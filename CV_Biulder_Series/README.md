...
| Introduction to the course | This is an introductory course designed for people who are from any background and are completely new to the area of image processing. |
| --- | --- |
| What does this course aim to achieve? | It aims to give hands-on experience with various OpenCV tools and functionalities with many example problems and their solutions for students to work on and understand the concepts. |
| What is being built in this course? | At the end of the course, students will be packed with all the necessary tools to perform the Build Tasks on their own.
- They will be building a program to detect and count pulse with a pre-recorded video.
- A program to cartoonize an image.
- And finally, a program that detects and tracks a ball bouncing on the ground with the bounce region and timestamp. |
...
- You will also use PIP which is a package manager for Python-based packages, that will be useful to install/uninstall and manages packages like OpenCV and NumPy, which one would be using throughout this build series.
...
- This is introductory course is designed for people who are from any background and are completely new to the area of image processing.
...
- At the end of the course, you will be packed with all the necessary tools to perform the Build Tasks on your own. And finally, we will guide you to upload your projects and work repository to your personal GitHub account.
- Hope you enjoy this!
...
- Reuse the “READING IMAGE FILE” code to read an image and display it.
...
- Before starting make sure that you have a GitHub account and GIT on your computer already.
...
- Now come back to the terminal/command prompt and run this command: `git remote add origin https://github.com/k-m-irfan/CV_Builder_Series.git` . This will link the remote and the local repository.
